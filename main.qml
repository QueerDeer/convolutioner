...
ApplicationWindow {
    ...
    signal qmlComputeAprioryFHT( string array1, string array2 );
    ...
    signal qmlComputeOverlapAddFHT( string array1, string array2 );
    ...
    signal qmlComputeOverlapSaveFHT( string array1, string array2 );
